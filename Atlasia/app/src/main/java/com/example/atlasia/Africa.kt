...
class Africa : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val goSubButton : Button = findViewById(R.id.eexploreButton)
        goSubButton.setOnClickListener{
            val intent = Intent(this,Egypt::class.java)
            startActivity(intent)
        }
        val subButton : Button = findViewById(R.id.mexploreButton)
        subButton.setOnClickListener{
            val intent = Intent(this,Morocco::class.java)
            startActivity(intent)
        }
        val itaButton : Button = findViewById(R.id.nexploreButton)
        itaButton.setOnClickListener{
            val intent = Intent(this,Nigeria::class.java)
            startActivity(intent)
        }
        val goToSubSelectButton : ImageButton = findViewById(R.id.backButton4)
        goToSubSelectButton.setOnClickListener{
            val intent = Intent(this,TripScreen::class.java)
            startActivity(intent)
        }
        val goSelectButton : ImageButton = findViewById(R.id.contButton3)
        goSelectButton.setOnClickListener{
            val intent = Intent(this,Continent::class.java)
            startActivity(intent)
        }
        val goButton : ImageButton = findViewById(R.id.calButton3)
        goButton.setOnClickListener{
            val intent = Intent(this,Calender::class.java)
            startActivity(intent)
        }
        val gotoButton : ImageButton = findViewById(R.id.listButton3)
        gotoButton.setOnClickListener{
            val intent = Intent(this,WishList::class.java)
            startActivity(intent)
        }
        val instButton: ImageButton = findViewById(R.id.instButton6)
