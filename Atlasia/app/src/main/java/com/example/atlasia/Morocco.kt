...
class Morocco : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val goToButton : Button = findViewById(R.id.calmorButton)
        goToButton.setOnClickListener{
            val intent = Intent(this,Calender::class.java)
            startActivity(intent)
        }
        val goToSubButton : ImageButton = findViewById(R.id.prevButton7)
        goToSubButton.setOnClickListener{
            val intent = Intent(this,Africa::class.java)
            startActivity(intent)
        }
        val addToWishlistButton = findViewById<Button>(R.id.morwishButton)
