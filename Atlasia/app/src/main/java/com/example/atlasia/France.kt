...
class France : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val goToButton : Button = findViewById(R.id.calfrButton)
        goToButton.setOnClickListener{
            val intent = Intent(this,Calender::class.java)
            startActivity(intent)
        }
        val goToSubButton : ImageButton = findViewById(R.id.prevButton6)
        goToSubButton.setOnClickListener{
            val intent = Intent(this,Europe::class.java)
            startActivity(intent)
        }
        val addToWishlistButton = findViewById<Button>(R.id.frwishButton)
