...
class Uae : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val goToButton : Button = findViewById(R.id.calueButton)
        goToButton.setOnClickListener{
            val intent = Intent(this,Calender::class.java)
            startActivity(intent)
        }
        val goToSubButton : ImageButton = findViewById(R.id.prevButton2)
        goToSubButton.setOnClickListener{
            val intent = Intent(this,Asia::class.java)
            startActivity(intent)
        }
        val addToWishlistButton = findViewById<Button>(R.id.uewishButton)
