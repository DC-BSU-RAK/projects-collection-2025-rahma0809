...
class Nigeria : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val goToButton : Button = findViewById(R.id.calniButton)
        goToButton.setOnClickListener{
            val intent = Intent(this,Calender::class.java)
            startActivity(intent)
        }
        val goToSubButton : ImageButton = findViewById(R.id.prevButton8)
        goToSubButton.setOnClickListener{
            val intent = Intent(this,Africa::class.java)
            startActivity(intent)
        }
        val addToWishlistButton = findViewById<Button>(R.id.niwishButton)
